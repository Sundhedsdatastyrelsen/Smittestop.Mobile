...
namespace NDB.Covid19.Droid.Views.AuthenticationFlow
{
    ...
    internal class QuestionnairePageActivity : AppCompatActivity
    {
        ...
        private ISpanned GetFormattedText =>
            HtmlCompat.FromHtml(
        ...
        private void OnNextButtonClick(object o, EventArgs args)
        {
            ...
            _questionnaireViewModel.InvokeNextButtonClick(
                GoToQuestionnaireCountriesSelectionPage, OnFail, OnValidationFail);
        }

        private void OnFail()
        {
            AuthErrorUtils.GoToTechnicalError(this, LogSeverity.ERROR, null,
                $"{nameof(QuestionnairePageActivity)}.{nameof(OnFail)}: " +
        ...
        {
            AuthErrorUtils.GoToTechnicalError(this, LogSeverity.ERROR, null,
                $"{nameof(QuestionnairePageActivity)}.{nameof(OnValidationFail)}: " +
        ...
        private class CustomRadioOnClickListener : Object, View.IOnClickListener
        {
