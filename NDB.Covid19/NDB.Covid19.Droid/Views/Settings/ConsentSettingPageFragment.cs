    ...
    public class ConsentSettingPageFragment : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            RelativeLayout RelativeLayout1 =
                view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_frivillig_brug);
            RelativeLayout RelativeLayout2 =
                view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_sadan_fungerer_appen);
            RelativeLayout RelativeLayout3 =
                view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_hvad_registreres);
            RelativeLayout RelativeLayout4 =
                view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_hvordan_accepterer);
            RelativeLayout RelativeLayout5 = view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_ret);
            RelativeLayout RelativeLayout6 =
                view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_kontaktregistringer);
            RelativeLayout RelativeLayout7 = view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_mere);
            RelativeLayout RelativeLayout8 =
                view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_behandlingen);
            RelativeLayout RelativeLayout9 =
                view.FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_aendringer);
            ...
            RelativeLayout1.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_ONE_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
            RelativeLayout2.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_TWO_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
            RelativeLayout3.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_THREE_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
            RelativeLayout4.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_FOUR_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
            RelativeLayout5.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_FIVE_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
            RelativeLayout6.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_SIX_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
            RelativeLayout7.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_SEVEN_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
            RelativeLayout8.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_EIGHT_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
            RelativeLayout9.FindViewById<TextView>(Resource.Id.consent_page_text).TextFormatted =
                HtmlCompat.FromHtml(ConsentViewModel.CONSENT_NINE_PARAGRAPH, HtmlCompat.FromHtmlModeLegacy);
        ...
        {
            EventHandler<bool> handler = ButtonPressed;
