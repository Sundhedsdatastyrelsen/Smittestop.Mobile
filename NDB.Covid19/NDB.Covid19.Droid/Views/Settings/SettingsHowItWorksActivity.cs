...
namespace NDB.Covid19.Droid.Views.Settings
{
    ...
    internal class SettingsHowItWorksActivity : AppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Title = SettingsPage2ViewModel.SETTINGS_PAGE_2_HEADER;
        ...
        private void Init()
        {
            ...
            string linkString =
                $"<a href=\"{SettingsPage2ViewModel.SETTINGS_PAGE_2_CONTENT_TEXT_PARAGRAPH_4_LINK}\">{SettingsPage2ViewModel.SETTINGS_PAGE_2_CONTENT_TEXT_PARAGRAPH_4_LINK_TEXT}</a>";
            linkField.TextFormatted = HtmlCompat.FromHtml(linkString, HtmlCompat.FromHtmlModeLegacy);
            FormatLink(linkField);
            linkField.SetOnClickListener(new OnClickListener(this,
