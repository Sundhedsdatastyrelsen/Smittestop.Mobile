    ...
    public class WelcomePageConsentsActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            RelativeLayout RelativeLayout2 =
                FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_sadan_fungerer_appen);
            RelativeLayout RelativeLayout3 =
                FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_hvad_registreres);
            RelativeLayout RelativeLayout4 =
                FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_hvordan_accepterer);
            RelativeLayout RelativeLayout5 = FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_ret);
            RelativeLayout RelativeLayout6 =
                FindViewById<RelativeLayout>(Resource.Id.consent_paragraph_kontaktregistringer);
        ...
        {
            return _switchCustom != null && _switchCustom.Checked;
        }
        ...
        {
            _consentWarning.Visibility = shown ? ViewStates.Visible : ViewStates.Gone;
