...
namespace NDB.Covid19.Droid.Utils
{
    public static class AuthErrorUtils
    {
        ...
        public static void GoToTechnicalErrorSSINumbers(Activity parent, LogSeverity severity, Exception e,
            string errorMessage)
        {
            GoToErrorPage(parent, REGISTER_ERROR_FETCH_SSI_DATA_HEADER, REGISTER_ERROR_FETCH_SSI_DATA_DESCRIPTION,
                REGISTER_ERROR_DISMISS);
            LogUtils.LogException(severity, e, errorMessage);
        }
