...
namespace NDB.Covid19.iOS.Utils
{
    public static class NavigationHelper
    {
        ...
        private static UIViewController CurrentTopViewController(UIViewController current)
        {
        ...
        private static bool IsIgnoredViewControllers(UIViewController vc)
        {
        ...
        {
            UIViewController enDeveloperTools = ViewControllerByStoryboardName("ENDeveloperTools");
        ...
        public static void GoToWelcomeWhatsNewPage(UIViewController parent)
        {
            ...
            WelcomePageWhatIsNewViewController vc =
                storyboard.InstantiateInitialViewController() as WelcomePageWhatIsNewViewController;
            vc.ModalPresentationStyle = UIModalPresentationStyle.FullScreen;
