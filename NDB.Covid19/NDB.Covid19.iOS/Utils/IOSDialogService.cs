...
namespace NDB.Covid19.iOS.Utils
{
    ...
    {
        public void ShowMessageDialog(string title, string message, string okBtn,
            PlatformDialogServiceArguments platformArguments)
        {
        ...
        private void AttempToLookForPresentViewController(
