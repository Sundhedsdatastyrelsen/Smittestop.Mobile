...
namespace NDB.Covid19.iOS
{
    ...
    public class SceneDelegate : UIResponder, IUIWindowSceneDelegate
    {
        ...
        public void WillEnterForeground(UIScene scene)
        {
            ...
            Debug.Print("WillEnterForeground");
        ...
        {
            Debug.Print("Open url from scene delegate");
            try
            {
            ...
            catch (Exception e)
            {
                LogUtils.LogException(LogSeverity.WARNING, e,
                    $"{nameof(SceneDelegate)}.{nameof(OpenUrlContexts)}: Failed to redirect the user to the app after NemID flow in browser");
            }
        }
    }
}