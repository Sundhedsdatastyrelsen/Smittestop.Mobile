...
namespace NDB.Covid19.iOS.Views.MessagePage
{
    ...
    {
        private List<MessageItemViewModel> _models = new List<MessageItemViewModel>();
        ...
        {
            ServiceLocator.Current.GetInstance<IBrowser>()
                .OpenAsync(_models[indexPath.Row].MessageLink, BrowserLaunchMode.SystemPreferred);
