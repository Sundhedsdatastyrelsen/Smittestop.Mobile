...
namespace NDB.Covid19.iOS.Views.Settings
{
    public partial class SettingsViewController : BaseViewController
    {
        ...
        private SettingsTableViewSource _tableSource
        {
        ...
        public static SettingsViewController Create()
        {
            ...
            SettingsViewController vc =
                (SettingsViewController) storyboard.InstantiateViewController(nameof(SettingsViewController));
            return vc;
        }
        ...
        private void OnCellTapped(object sender, SettingItemType type)
        {
            switch (type)
            {
                ...
                case SettingItemType.HowItWorks:
                    UIViewController SettingsPage2ViewController =
                        NavigationHelper.ViewControllerByStoryboardName("SettingsPage2");
                    NavigationController?.PushViewController(SettingsPage2ViewController, true);
                    break;
                case SettingItemType.Consent:
                    UIViewController settingsConsetnController =
                        NavigationHelper.ViewControllerByStoryboardName("SettingsPage3");
                    NavigationController?.PushViewController(settingsConsetnController, true);
                    break;
                case SettingItemType.Help:
                    UIViewController SettingsPage4ViewController =
                        NavigationHelper.ViewControllerByStoryboardName("SettingsPage4");
                    NavigationController?.PushViewController(SettingsPage4ViewController, true);
                    break;
                case SettingItemType.Settings:
                    UIViewController SettingsPageGeneralSettingsViewController =
                        NavigationHelper.ViewControllerByStoryboardName("SettingsPageGeneralSettings");
                    NavigationController?.PushViewController(SettingsPageGeneralSettingsViewController, true);
                    break;
                case SettingItemType.About:
                    UIViewController SettingsPage5ViewController =
                        NavigationHelper.ViewControllerByStoryboardName("SettingsPage5");
