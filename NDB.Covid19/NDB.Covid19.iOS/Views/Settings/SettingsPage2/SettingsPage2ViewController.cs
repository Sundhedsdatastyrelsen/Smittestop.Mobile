...
using ConsentViewModel = NDB.Covid19.Models.ConsentViewModel;
...
namespace NDB.Covid19.iOS.Views.Settings.SettingsPage2
{
    ...
    {
        private ConsentViewModel _consentViewModel;
        ...
        private void SetTexts()
        {
            ...
            InitLabel(UrlLabel, FontType.FontRegular,
                SettingsPage2ViewModel.SETTINGS_PAGE_2_CONTENT_TEXT_PARAGRAPH_4_LINK_TEXT, 16, 28);
            ...
            //Accessibility
            HeaderLabel.AccessibilityAttributedLabel =
                AccessibilityUtils.RemovePoorlySpokenSymbols(SettingsPage2ViewModel.SETTINGS_PAGE_2_HEADER);
        ...
        private void OpenWebPageBtnTapped(UITapGestureRecognizer recognizer)
        {
            ServiceLocator.Current.GetInstance<IBrowser>().OpenAsync(
                SettingsPage2ViewModel.SETTINGS_PAGE_2_CONTENT_TEXT_PARAGRAPH_4_LINK,
                BrowserLaunchMode.SystemPreferred);
        }

        private NSMutableAttributedString ApplyStylingToText(string text, FontType fontType, double lineHeight,
            int fontSize, int maxFontSize, bool isLink)
        {
            ...
            NSError error = null;
            NSAttributedString attributedString = new NSAttributedString(NSData.FromString(html, NSStringEncoding.UTF8),
            ...
            attributedTextToAppend.AddAttribute(UIStringAttributeKey.Font, Font(fontType, fontSize, maxFontSize),
                range);
