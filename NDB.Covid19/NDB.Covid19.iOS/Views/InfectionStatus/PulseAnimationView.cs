...
namespace NDB.Covid19.iOS.Views.InfectionStatus
{
    ...
    {
        private readonly CAAnimationGroup _animationGroup;
        ...
        private CAAnimationGroup CreateAnimation()
        {
            ...
            opacityAnimation.KeyTimes = new[] {NSNumber.FromFloat(0), NSNumber.FromFloat(0.3f), NSNumber.FromFloat(1)};
            opacityAnimation.Values = new[] {NSNumber.FromFloat(0.4f), NSNumber.FromFloat(0.8f), NSNumber.FromFloat(0)};
