...
namespace NDB.Covid19.iOS.Views.CustomSubclasses
{
    public partial class SettingsContentTextView : UITextView
    {
        ...
        private void Setup()
        {
            ...
            NSError error = null;
            NSAttributedString attributedString = new NSAttributedString(NSData.FromString(Text, NSStringEncoding.UTF8),
                documentAttributes, ref error);

            //Ensuring text is resiezed correctly when font size is increased
            InitTextViewWithSpacingAndUrl(this, FontType.FontRegular, attributedString, 1.28, 16, 22);
            ...
            WeakLinkTextAttributes = new NSDictionary(UIStringAttributeKey.ForegroundColor, "#FADC5D".ToUIColor(),
