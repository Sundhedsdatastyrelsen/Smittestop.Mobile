...
namespace NDB.Covid19.iOS.Views.ConsentView
{
    ...
    partial class ConsentViewController
    {
        ...
        UIKit.UIView BottomControlsView { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        NDB.Covid19.iOS.Views.CustomSubclasses.FocusableButton PrivacyPolicy { get; set; }
        ...
        [GeneratedCode ("iOS Designer", "1.0")]
        partial void PrivacyPolicy_TouchUpInside (NDB.Covid19.iOS.Views.CustomSubclasses.FocusableButton sender);

        void ReleaseDesignerOutlets ()
        {
            if (BottomControlsView != null) {
                BottomControlsView.Dispose ();
