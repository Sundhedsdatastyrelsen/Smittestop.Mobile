...
namespace NDB.Covid19.iOS.Views.AuthenticationFlow.QuestionnaireCountries
{
    public partial class CountryTableCell : UITableViewCell
    {
        ...
        {
            StyleUtil.InitLabelWithSpacing(CountryNameLabel, StyleUtil.FontType.FontRegular, country.Name, 1.14, 16,
                28);
            CheckboxImage.Image = country.Checked
                ? UIImage.FromBundle("CheckboxChecked")
                : UIImage.FromBundle("CheckboxUnchecked");
