...
namespace NDB.Covid19.iOS.Views.AuthenticationFlow
{
    public partial class InformationAndConsentViewController : BaseViewController
    {
        ...
        public static InformationAndConsentViewController GetInformationAndConsentViewController()
        {
            ...
            InformationAndConsentViewController vc =
                storyboard.InstantiateInitialViewController() as InformationAndConsentViewController;
        ...
        public override void ViewDidLoad()
        {
            ...
            StyleUtil.InitButtonStyling(LoginNemIDBtn,
                InformationAndConsentViewModel.INFORMATION_CONSENT_NEMID_BUTTON_TEXT);
        }
        ...
        private void OnAuthError(object sender, AuthErrorType authErrorType)
        {
            _viewModel.Cleanup();

            Debug.Print("OnAuthError");
            LoginNemIDBtn.HideSpinner();
            AuthErrorUtils.GoToErrorPageForAuthErrorType(this, authErrorType);
        ...
        {
            InvokeOnMainThread(() => { LoginNemIDBtn.ShowSpinner(View, UIActivityIndicatorViewStyle.White); });
        ...
        public Task<string> GetDeviceVerificationToken()
        {
            ...
            DCDevice.CurrentDevice.GenerateToken((token, error) =>
            {
                if (error == null)
                {
                ...
                else
                {
                    ...
                    tcs.SetException(
                        new DeviceVerificationException("Failed to obtain the device token from DeviceCheck API"));
                }
            });
            return tcs.Task;
        }
