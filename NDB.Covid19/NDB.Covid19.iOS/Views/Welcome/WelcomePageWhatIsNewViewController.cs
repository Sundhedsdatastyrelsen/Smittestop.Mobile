...
namespace NDB.Covid19.iOS.Views.Welcome
{
    public partial class WelcomePageWhatIsNewViewController : BaseViewController
    {
        ...
        {
            InitLabelWithSpacing(TitleLabel, FontType.FontBold,
                WelcomePageWhatIsNewViewModel.WELCOME_PAGE_WHATS_NEW_TITLE, 1.14, 24, 26);
            InitLabelWithSpacing(Label1, FontType.FontRegular,
                WelcomePageWhatIsNewViewModel.WELCOME_PAGE_WHATS_NEW_BULLET_ONE, 1.28, 16, 22);
            InitLabelWithSpacing(Label2, FontType.FontRegular,
                WelcomePageWhatIsNewViewModel.WELCOME_PAGE_WHATS_NEW_BULLET_TWO, 1.28, 16, 22);
            InitLabelWithSpacing(Label3, FontType.FontRegular,
                WelcomePageWhatIsNewViewModel.WELCOME_PAGE_WHATS_NEW_BULLET_THREE, 1.28, 16, 22);
            InitLabelWithSpacing(LabelBottom, FontType.FontRegular,
                WelcomePageWhatIsNewViewModel.WELCOME_PAGE_WHATS_NEW_FOOTER, 1.28, 16, 22);
