...
namespace NDB.Covid19.iOS.Views.ENDeveloperTools
{
    ...
    {
        private ENDeveloperToolsViewModel _enDeveloperViewModel;
        ...
        {
            Task.Run(async () => { await _enDeveloperViewModel.SimulateExposureMessage(); });
        }
        ...
        private void updateUI()
        {
            ...
            ServiceLocator.Current.GetInstance<IClipboard>().SetTextAsync(_enDeveloperViewModel.DevToolsOutput)
        ...
        private void ShowModalAlertView(string title, string message)
        {
