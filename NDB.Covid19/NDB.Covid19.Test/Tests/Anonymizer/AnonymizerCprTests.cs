...
namespace NDB.Covid19.Test.Tests.Anonymizer
{
    ...
    {
        private readonly string replacementContinuousCase = "xxxxxxxxxx";
        private readonly string replacementKebabCase = "xxxxxx-xxxx";
        private readonly string replacementSpaceCase = "xxxxxx xxxx";
        ...
        public void CprInRandomStringChainShouldBeHidden()
        {
            ...
            ReplaceCpr(testString1 + testCpr1 + testString2).Should()
                .Be($"{testString1}{replacementKebabCase}{testString2}");
            ReplaceCpr($"{testString1} {testCpr1} {testString2}").Should()
                .Be($"{testString1} {replacementKebabCase} {testString2}");
