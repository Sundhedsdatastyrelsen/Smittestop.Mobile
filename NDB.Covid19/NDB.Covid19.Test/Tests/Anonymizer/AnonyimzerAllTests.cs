...
namespace NDB.Covid19.Test.Tests.Anonymizer
{
    ...
    {
        private readonly string replacementCpr = "xxxxxx-xxxx";
        private readonly string replacementEmail = "****@*****.com";
        private readonly string replacementImei = "xxxxxxxxxxxxxxx";
        private readonly string replacementMacAddress = "xx:xx:xx:xx";
        private readonly string replacementPhoneNumber = "&amp;#43;xxxxxxxxxx";
