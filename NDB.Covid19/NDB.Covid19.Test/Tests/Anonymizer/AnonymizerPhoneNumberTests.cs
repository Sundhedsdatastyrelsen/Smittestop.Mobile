...
namespace NDB.Covid19.Test.Tests.Anonymizer
{
    ...
    {
        private readonly string replacementDirectional = "+xx";
        private readonly string replacementFourSpaced = "xx-xx-xx-xx";
        private readonly string replacementShort = "xxxxxxxx";
        private readonly string replacementTwoSpaced = "xxxx-xxxx";
