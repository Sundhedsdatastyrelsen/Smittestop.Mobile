...
namespace NDB.Covid19.Test.Tests.Anonymizer
{
    ...
    {
        private readonly string replacementImei = "xxxxxxxxxxxxxxx";
        ...
        public void IncorrectImeiChainShouldBeShown()
        {
            ...
            ReplaceIMEI($"{incorrectImeiNumber}{incorrectImeiNumber}").Should()
                .Be($"{incorrectImeiNumber}{incorrectImeiNumber}");
            ReplaceIMEI($"{incorrectImeiNumber} {incorrectImeiNumber}").Should()
                .Be($"{incorrectImeiNumber} {incorrectImeiNumber}");

            ReplaceIMEI($"{correctImeiNumber}{incorrectImeiNumber}").Should()
                .Be($"{replacementImei}{incorrectImeiNumber}");
            ReplaceIMEI($"{correctImeiNumber} {incorrectImeiNumber}").Should()
                .Be($"{replacementImei} {incorrectImeiNumber}");

            ReplaceIMEI($"{incorrectImeiNumber}{correctImeiNumber}").Should()
                .Be($"{incorrectImeiNumber}{replacementImei}");
            ReplaceIMEI($"{incorrectImeiNumber} {correctImeiNumber}").Should()
                .Be($"{incorrectImeiNumber} {replacementImei}");
        }
        ...
        public void CorrectImeiInStringShouldBeHidden()
        {
            ...
            ReplaceIMEI($"{testString1}{correctImeiNumber}{testString2}").Should()
                .Be($"{testString1}{replacementImei}{testString2}");
            ReplaceIMEI($"{testString1} {correctImeiNumber} {testString2}").Should()
                .Be($"{testString1} {replacementImei} {testString2}");
        }
    }
