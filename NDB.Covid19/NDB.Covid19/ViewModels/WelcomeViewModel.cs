...
namespace NDB.Covid19.ViewModels
{
    public class WelcomeViewModel
    {
        ...
        public static string WELCOME_PAGE_THREE_BODY_ONE_ACCESSIBILITY =>
            "WELCOME_PAGE_THREE_BODY_ONE_ACCESSIBILITY".Translate();
        ...
        public static string WELCOME_PAGE_BACKGROUND_LIMITATIONS_NEXT_BUTTON =>
            "WELCOME_PAGE_BACKGROUND_LIMITATIONS_NEXT_BUTTON".Translate();

        // Accessibility announcements onBoarding
        public static string ANNOUNCEMENT_PAGE_CHANGED_TO_ONE =>
            "WELCOME_PAGE_ACCESSIBILITY_ANNOUNCEMENT_PAGE_CHANGED_TO_ONE".Translate();

        public static string ANNOUNCEMENT_PAGE_CHANGED_TO_TWO =>
            "WELCOME_PAGE_ACCESSIBILITY_ANNOUNCEMENT_PAGE_CHANGED_TO_TWO".Translate();

        public static string ANNOUNCEMENT_PAGE_CHANGED_TO_THREE =>
            "WELCOME_PAGE_ACCESSIBILITY_ANNOUNCEMENT_PAGE_CHANGED_TO_THREE".Translate();

        public static string ANNOUNCEMENT_PAGE_CHANGED_TO_FOUR =>
            "WELCOME_PAGE_ACCESSIBILITY_ANNOUNCEMENT_PAGE_CHANGED_TO_FOUR".Translate();
        ...
        public static string WELCOME_PAGE_TWO_ACCESSIBILITY_BODY_ONE =>
            "WELCOME_PAGE_TWO_ACCESSIBILITY_BODY_ONE".Translate();
    }
}