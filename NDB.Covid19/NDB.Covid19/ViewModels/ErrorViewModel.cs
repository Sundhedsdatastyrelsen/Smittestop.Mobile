...
namespace NDB.Covid19.ViewModels
{
    public static class ErrorViewModel
    {
        ...
        public static string REGISTER_ERROR_TOOMANYTRIES_DESCRIPTION =>
            "REGISTER_ERROR_TOOMANYTRIES_DESCRIPTION".Translate();
        ...
        public static string REGISTER_ERROR_ACCESSIBILITY_CLOSE_BUTTON_TEXT =>
            "REGISTER_ERROR_ACCESSIBILITY_CLOSE_BUTTON_TEXT".Translate();

        public static string REGISTER_ERROR_ACCESSIBILITY_TOOMANYTRIES_HEADER =>
            "REGISTER_ERROR_ACCESSIBILITY_TOOMANYTRIES_HEADER".Translate();

        public static string REGISTER_ERROR_ACCESSIBILITY_TOOMANYTRIES_DESCRIPTION =>
            "REGISTER_ERROR_ACCESSIBILITY_TOOMANYTRIES_DESCRIPTION".Translate();

        public static string REGISTER_ERROR_FETCH_SSI_DATA_HEADER => "REGISTER_ERROR_FETCH_SSI_DATA_HEADER".Translate();

        public static string REGISTER_ERROR_FETCH_SSI_DATA_DESCRIPTION =>
            "REGISTER_ERROR_FETCH_SSI_DATA_DESCRIPTION".Translate();
    }
}