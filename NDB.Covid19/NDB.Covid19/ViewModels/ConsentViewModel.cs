...
namespace NDB.Covid19.ViewModels
{
    public class ConsentViewModel
    {
        ...
        public static string SWITCH_ACCESSIBILITY_CONSENT_SWITCH_DESCRIPTOR =>
            "WELCOME_PAGE_FIVE_ACCESSIBILITY_CONSENT_SWITCH".Translate();

        public static string SWITCH_ACCESSIBILITY_ANNOUNCEMENT_CONSENT_GIVEN =>
            "WELCOME_PAGE_FIVE_SWITCH_ACCESSIBILITY_ANNOUNCEMENT_CONSENT_GIVEN".Translate();

        public static string SWITCH_ACCESSIBILITY_ANNOUNCEMENT_CONSENT_NOT_GIVEN =>
            "WELCOME_PAGE_FIVE_SWITCH_ACCESSIBILITY_ANNOUNCEMENT_CONSENT_NOT_GIVEN".Translate();

        public static string CONSENT_THREE_PARAGRAPH_ACCESSIBILITY =>
            "CONSENT_THREE_PARAGRAPH_ACCESSIBILITY".Translate();
        ...
        public List<Models.ConsentViewModel.ConsentSectionTexts> GetConsentSectionsTexts()
        {
            return new List<Models.ConsentViewModel.ConsentSectionTexts>
            {
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_ONE_TITLE, CONSENT_ONE_PARAGRAPH, null),
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_TWO_TITLE, CONSENT_TWO_PARAGRAPH, null),
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_THREE_TITLE, CONSENT_THREE_PARAGRAPH,
                    CONSENT_THREE_PARAGRAPH_ACCESSIBILITY),
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_FOUR_TITLE, CONSENT_FOUR_PARAGRAPH, null),
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_FIVE_TITLE, CONSENT_FIVE_PARAGRAPH, null),
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_SIX_TITLE, CONSENT_SIX_PARAGRAPH, null),
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_SEVEN_TITLE, CONSENT_SEVEN_PARAGRAPH,
                    CONSENT_SEVEN_PARAGRAPH.Replace("|", "")),
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_EIGHT_TITLE, CONSENT_EIGHT_PARAGRAPH, null),
                new Models.ConsentViewModel.ConsentSectionTexts(CONSENT_NINE_TITLE, CONSENT_NINE_PARAGRAPH, null)
            };
        }
    }
}