...
{
    /// <summary>
    ///     This class runs in Release mode. If anything is added to DeveloperToolsService, it should also be added to this
    ///     method.
    ///     Consider what should happen in Test mode (DeveloperToolsService) and what should happen in Release mode
    ///     (ReleaseToolsService).
    /// </summary>
