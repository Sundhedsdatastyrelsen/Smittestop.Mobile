...
namespace NDB.Covid19.Utils.DeveloperTools
{
    public sealed class DeveloperToolsService : IDeveloperToolsService
    {
        ...
        public static readonly string DEV_TOOLS_SHOULD_SAVE_EXPOSURE_INFOS_PREF =
            "DEV_TOOLS_SHOULD_SAVE_EXPOSURE_INFOS_PREF";
        ...
        {
            get => _preferences.Get(DEV_TOOLS_LAST_KEY_UPLOAD_INFO, "");
            set => _preferences.Set(DEV_TOOLS_LAST_KEY_UPLOAD_INFO, value);
        }
        ...
        {
            get => _preferences.Get(DEV_TOOLS_LAST_USED_CONFIGURATION, "");
            set => _preferences.Set(DEV_TOOLS_LAST_USED_CONFIGURATION, value);
        }
        ...
        {
            get => _preferences.Get(DEV_TOOLS_SHOULD_SAVE_EXPOSURE_INFOS_PREF, false);
            set => _preferences.Set(DEV_TOOLS_SHOULD_SAVE_EXPOSURE_INFOS_PREF, value);
        }

        public string LastProvidedFilesPref
        {
            get => _preferences.Get(DEV_TOOLS_LAST_PROVIDED_FILES_PREF, "");
            set => _preferences.Set(DEV_TOOLS_LAST_PROVIDED_FILES_PREF, value);
        }
        ...
        public void StoreLastProvidedFiles(IEnumerable<string> localFileUrls)
        {
            string allFilesString =
                $"TEK batch files downloaded at {SystemTime.Now().ToGreGorianUtcString("yyyy-MM-dd HH:mm:ss")} UTC:\n#######\n";
            ...
            foreach (string localFileUrl in localFileUrls)
            {
                ...
                TemporaryExposureKeyExport temporaryExposureKeyExport =
                    BatchFileHelper.ZipToTemporaryExposureKeyExport(zipArchive);
        ...
        public async Task SaveLastExposureInfos(Func<Task<IEnumerable<ExposureInfo>>> getExposureInfo)
        {
            ...
            {
                Debug.Print(
                    "ExposureDetectedHelper.DevToolsSaveLastExposureInfos: Couldn't fetch DEV_TOOLS_SHOULD_SAVE_EXPOSURE_INFOS_PREF from preferences");
            ...
            if (shouldSaveExposureInfos)
            {
                ...
                catch (Exception e)
                {
                    LogUtils.LogException(LogSeverity.WARNING, e,
                        "ExposureDetectedHelper.DevToolsSaveLastExposureInfos");
                }
            }
        }
        ...
        public string TemporaryExposureKeyExportToPrettyString(TemporaryExposureKeyExport temporaryExposureKeyExport)
        {
            ...
            catch (Exception e)
            {
                LogUtils.LogException(LogSeverity.ERROR, e,
                    "DeveloperToolsService.TemporaryExposureKeyExportToPrettyString");
                return "";
            }
        }
        ...
        {
            get => _preferences.Get(PreferencesKeys.DEV_TOOLS_PULL_KEYS_HISTORY, "");
            set => _preferences.Set(PreferencesKeys.DEV_TOOLS_PULL_KEYS_HISTORY, value);
        }

        public string LastPullHistory
        {
            get => _preferences.Get(PreferencesKeys.DEV_TOOLS_PULL_KEYS_HISTORY_LAST_RECORD, "");
            set => _preferences.Set(PreferencesKeys.DEV_TOOLS_PULL_KEYS_HISTORY_LAST_RECORD, value);
        }
