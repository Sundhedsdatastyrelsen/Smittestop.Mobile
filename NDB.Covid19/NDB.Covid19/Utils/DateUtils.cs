        ...
        public static string GetDateFromDateTime(this DateTime? date, string dateFormat)
        {
            if (date != null)
            {
                ...
                bool currentCultureIsSupported =
                    Conf.SUPPORTED_LANGUAGES.Contains(cultureInfo.TwoLetterISOLanguageName);
                ...
                string dateString =
                    calenderDateTime.ToString(
                        dateFormat,
                        currentCultureIsSupported ? cultureInfo : defaultCultureInfo);
