namespace NDB.Covid19.Configuration
{
    ...
    {
        public static string OAUTH2_CLIENT_ID = "INJECTED_DURING_BUILD";
        public static string OAUTH2_SCOPE = "INJECTED_DURING_BUILD";
        public static string OAUTH2_REDIRECT_URL = "INJECTED_DURING_BUILDt";
