...
namespace NDB.Covid19.Configuration
{
    public class Conf
    {
        ...
        // Max response content buffer size in bytes
        public static int MAX_CONTENT_BUFFER_SIZE = 10000000;

        // Year replacement in case of wrong or no DateTime on device
        ...
        public static readonly Tuple<int, int>[] DAYS_SINCE_ONSET_FOR_TRANSMISSION_RISK_CALCULATION =
        {
            ...
            Tuple.Create(int.MinValue,
                int.MaxValue), // For array index 1 (Represents Lowest risk, should be set for all the keys)
        ...
        public static readonly string[] SUPPORTED_REGIONS = {"dk"};

        //Links for Apples app store and Googles Play store
        public static string GooglePlayAppLink =
            "https://play.google.com/store/apps/details?id=com.netcompany.smittestop_exposure_notification";
