...
namespace NDB.Covid19.PersistedData.SecureStorage
{
    ...
    public static class SecureStorageKeys
    {
        ...
        public static readonly string DAILY_SUMMARIES_OVER_THRESHOLD_TIMESTAMP_KEY =
            "DAILY_SUMMARIES_OVER_THRESHOLD_TIMESTAMP_KEY";

        public static IEnumerable<string> GetAllKeysForCleaningDevice()
        {
            IEnumerable<object> fieldValues = typeof(SecureStorageKeys).GetFields()
                .Select(field => field.GetValue(typeof(SecureStorageKeys)));
