...
namespace NDB.Covid19.Models
{
    ...
    {
        public ExposureKeyModel(TemporaryExposureKey tek) : base(tek.Key, tek.RollingStart, tek.RollingDuration,
            tek.TransmissionRiskLevel)
        {
        }
        ...
        public ExposureKeyModel(
            ...
            DateTimeOffset rollingStart,
            TimeSpan rollingDuration,
            RiskLevel transmissionRisk, int daysSinceOnsetOfSymptoms) : base(keyData, rollingStart, rollingDuration,
            transmissionRisk)
        {
