...
namespace NDB.Covid19.Models
{
    public class PersonalDataModel
    {
        ...
        [JsonIgnore] public string Access_token { get; set; }
        ...
        [JsonIgnore] public bool IsBlocked => Covid19_blokeret == "true";

        [JsonIgnore] public bool IsNotInfected => Covid19_status == "negativ";

        [JsonIgnore] public bool UnknownStatus => Covid19_status == "ukendt";
        ...
        public bool Validate()
        {
            ...
            if (!startDateOK)
            {
                LogUtils.LogMessage(LogSeverity.ERROR, logPrefix + "Covid19_smitte_start value was null or empty");
            }

            bool notExpired = TokenExpiration != null && TokenExpiration > DateTime.Now;
            if (!notExpired)
            {
                LogUtils.LogMessage(LogSeverity.ERROR, logPrefix + "Access token was expired");
            }
