...
namespace NDB.Covid19
{
    public class MigrationService
    {
        ...
        private void MigrateToVersion1()
        {
            ...
            try
            {
                string stringValue = _preferences.Get(PreferencesKeys.CURRENT_DAY_TO_DOWNLOAD_KEYS_FOR_UTC_PREF,
                    "defaultvalue");
                DateTime dateTimeValue = DateTime.Parse(stringValue);
                newValue = dateTimeValue;
            }
        ...
        {
            DateTime lastDatePulledSucceeded =
                _preferences.Get(PreferencesKeys.CURRENT_DAY_TO_DOWNLOAD_KEYS_FOR_UTC_DATETIME_PREF, DateTime.MinValue);
