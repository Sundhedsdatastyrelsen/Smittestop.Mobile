...
namespace NDB.Covid19.WebServices.ExposureNotification
{
    public class ExposureNotificationWebService : BaseWebService
    {
        ...
        {
            ApiResponse<AttenuationBucketsConfigurationDTO> response =
                await Get<AttenuationBucketsConfigurationDTO>(Conf.URL_GET_EXPOSURE_CONFIGURATION);
            HandleErrorsSilently(response);
            ...
            if (response.IsSuccessfull && response.Data != null && response.Data.Configuration != null)
            {
                ...
                {
                    LocalPreferencesHelper.ExposureTimeThreshold =
                        response.Data.AttenuationBucketsParams.ExposureTimeThreshold;
                    LocalPreferencesHelper.LowAttenuationDurationMultiplier =
                        response.Data.AttenuationBucketsParams.LowAttenuationBucketMultiplier;
                    LocalPreferencesHelper.MiddleAttenuationDurationMultiplier =
                        response.Data.AttenuationBucketsParams.MiddleAttenuationBucketMultiplier;
                    LocalPreferencesHelper.HighAttenuationDurationMultiplier =
                        response.Data.AttenuationBucketsParams.HighAttenuationBucketMultiplier;
                }
